...
In this section, we provide some theoretical results on how well uniform bundle pricing and item pricing can approximate the 
optimal subadditive bundle pricing. 
...
Adding up all inequalities, we get:
	...
	%< \frac{\textsf{OPT}}{\log m} (\frac{1}{m} + \frac{1}{m-1} + \dots + 1) \\
	%& \leq \textsf{OPT}
	\end{aligned}
	\end{equation*}
\end{proof}
