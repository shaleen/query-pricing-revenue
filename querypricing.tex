...
Given the above three subclasses of pricing functions, we answer the following two questions, both from a theoretical and practical point of view.
First, how much do we lose in terms of revenue by replacing the optimal monotone and subadditive pricing function with one a uniform, additive or XOS price?

 $(i)$ how well can each pricing function approximate the optimal revenue? 
$(ii)$ can we algorithmically compute the optimal prices, and what approximation guarantees do we obtain? 
